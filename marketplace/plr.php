                ...
                <div class="marketplace-main-grid">
                    <div class="container-marketplace">
                        ...
                        <ul class="menu-categorias">
                            <li><a href="categoria.php?nome=plr">PLR</a></li>
                            <li><a href="categoria.php?nome=encapsulados">Encapsulados</a></li>
                            <li><a href="categoria.php?nome=cosmeticos">Cosméticos</a></li>
                        </ul>

                        <!-- Exibição de Cursos da Categoria "PLR" -->
